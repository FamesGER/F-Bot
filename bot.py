...
async def on_message(message):
	...
	if ("PAY" in  message.content.upper() and ("RESPECT" in message.content.upper())  or "RESPECC" message.content.upper) or ("PRESS" in message.content.upper() and "F" in message.content.upper()) or message.content.upper().startswith("F") :
		if message.content.upper().startswith("F") and len(message.content) > 1:
			if ("PAY" in  message.content.upper() and ("RESPECT" in message.content.upper())  or "RESPECC" message.content.upper in message.content.upper()) or ("PRESS" in message.content.upper() and "F" in message.content.upper()):
				await bot.add_reaction(message, emoji = "🇫")
			return
		await bot.add_reaction(message, emoji = "🇫")
